...
public class BarterTrait extends Trait {
    public BarterTrait() {
        super("barterplus");
        plugin = JavaPlugin.getPlugin(BarterPlus.class);
    }

    BarterPlus plugin = null;
...
//            BarterPlus.inst().getLogger().info("NPC is now targeting " + event.getPlayer().getName());
//        } else {
//            BarterPlus.inst().getLogger().info("NPC is not targeting " + event.getPlayer().getName());
//        }
    }
