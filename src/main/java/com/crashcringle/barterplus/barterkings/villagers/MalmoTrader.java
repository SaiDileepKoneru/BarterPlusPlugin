package com.crashcringle.barterplus.barterkings.villagers;
...
public class MalmoTrader implements Merchant {
    ...
    public void printRecipes() {
        ...
        BarterPlus.inst().getLogger().log(Level.INFO, "Malmo Trader Recipes");
        mTrader.getRecipes().forEach(recipe -> {
            BarterPlus.inst().getLogger().log(Level.INFO, "Recipe: " + recipe.getResult().getType());
            recipe.getIngredients().forEach(itemStack -> {
                BarterPlus.inst().getLogger().log(Level.INFO, "Ingredient: " + itemStack.getType());
            });
            BarterPlus.inst().getLogger().log(Level.INFO, "**********************************");
        });
    }
